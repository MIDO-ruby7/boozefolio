...
Rails.application.configure do
  ...
  config.assets.precompile += ['top_bubble.js', 'bubble.js', 'tourguide.js', 'search.js', 'default_values.js', 'preview.js']
  ...
  # config.active_job.queue_name_prefix = "boozefolio_production"
